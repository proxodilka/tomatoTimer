    ...
    TimingField.prototype = {
        ...
        inputHour: function() {
            if (!this.disabled) {
                ...
                if (this.getHours().value=="")
                    this.getHours().value=0;
                this.getHours().value = parseInt(this.getHours().value.replace(/\D+/g,""));
            }
        ...
        inputMin: function() {
            if (!this.disabled) {
                ...
                if (this.getMinutes().value=="")
                    this.getMinutes().value=0;
                this.getMinutes().value = parseInt(this.getMinutes().value.replace(/\D+/g,""));
                this.updateElem();
            }
        },
        upSec: function() {
        ...
        inputSec: function() {
            if (!this.disabled) {
                ...
                if (this.getSeconds().value=="")
                    this.getSeconds().value=0;
                this.getSeconds().value = parseInt(this.getSeconds().value.replace(/\D+/g,""));
                this.updateElem();
            }
        },
        disable: function() {
